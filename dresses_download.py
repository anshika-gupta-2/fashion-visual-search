...
# File paths
csv_path = r"C:\Users\91981\Downloads\Dresses\data\dresses_bd_processed_data.csv"
checkpoint_path = "data/dresses_with_image_paths.csv"  # ✅ updated file name for dresses
...
# Make directories
os.makedirs("dresses_images/feature", exist_ok=True)  # ✅ updated folder
os.makedirs("dresses_images/pdp", exist_ok=True)      # ✅ updated folder
...
def process_row(idx, row):
    ...
    if isinstance(feature_url, str) and feature_url.startswith("http"):
        feature_path = f"dresses_images/feature/{product_id}.jpg"
    ...
    try:
        ...
        for i, url in enumerate(pdp_urls):
            if isinstance(url, str) and url.startswith("http"):
                pdp_path = f"dresses_images/pdp/{product_id}_{i}.jpg"
